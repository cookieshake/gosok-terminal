...
export default function FeedPanel({ onClose }: FeedPanelProps) {
  const { feedMessages, clearFeed } = useEventsContext();
  ...
  return (
    <div className="flex flex-col h-full bg-white border-l border-gray-200">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {feedMessages.length === 0 ? (
          <p className="text-sm text-gray-400 text-center mt-8">No posts yet</p>
        ) : (
