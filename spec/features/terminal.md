...
- On mobile, a tap on the terminal area MUST focus the hidden textarea to trigger the soft keyboard. A gesture where the finger moved more than 5 pixels in any direction MUST NOT focus the textarea (i.e., scrolling or swiping must not open the keyboard).
